...
# train by 2-gpu
python3 train_dmc.py --env swy-blm --xpid bailongmen --cuda 0,1 --num_actor_devices 1 --training_device 1 --num_actors 8 --savedir results/dmc_results --total_iterations 2000000
